...
def get_db_time():
        req = "disable"
        conn = connect("host= {0} dbname={1} user={2} password={3} sslmode={4}".format(get_db_config('db_host'), get_db_config('db_name'), get_db_config('db_user'), get_db_config('db_password'), req))	
